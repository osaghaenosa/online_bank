...
import { Edit, Lock, LogOut, Bell, CreditCard, Bitcoin, Settings, Key, TrendingUp } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    api.user.notifications().then(d => { setNotifs(d.notifications); setUnread(d.unreadCount) }).catch(()=>{})
  }, [])
    ...
    <div className="max-w-5xl space-y-5 fade-up">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2 space-y-5">
          ...
          <Card className="p-6">
            <div className="flex items-center gap-4 mb-5">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-white text-xl font-bold flex-shrink-0" style={{ background:'#0F1C35' }}>
        ...
        <div className="space-y-5">
          ...
          <Card className="p-5" style={{ background:'#0F1C35' }}>
            ...
            {hasWealth && (
              <>
                ...
                <p className="font-mono text-xl font-bold" style={{ color:'#F59E0B' }}>{fmtUSD(netWorth)}</p>
              </>
            )}
          </Card>
          ...
          {hasWealth && (
            <Link href="/wealth">
              <div className="flex items-center gap-4 p-5 rounded-2xl cursor-pointer group hover:opacity-90 transition-opacity"
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white/50 text-xs">Crypto · Treasury · Investments · Trust</p>
                </div>
