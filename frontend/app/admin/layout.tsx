...
import { LayoutDashboard, Users, List, Settings, Bell, FileEdit, ShieldAlert, MessageCircle } from 'lucide-react'
  ...
  return (
    <AppShell>
      <div className="max-w-7xl w-full">
        ...
        {/* Scrollable tab bar */}
        <div className="flex gap-1 p-1.5 rounded-2xl mb-6 overflow-x-auto scrollbar-none"
          ...
          {ADMIN_NAV.map(({ href, label, icon: Icon, exact }) => {
            ...
            return (
              <Link key={href} href={href}
                ...
                style={active ? { background: activeBg } : { color: 'var(--color-muted)' }}>
                <Icon size={13} />
                {label}
              </Link>
            )
